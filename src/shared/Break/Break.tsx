...
export function Break(props: IBreakProps) {
	...
	return <div className={classNames(styles[`s${size}`], { [styles[`mobile_s${mobileSize}`]]: mobileSize }, { [styles[`tablet_t${tabletSize}`]]: tabletSize }, { [styles[`desktop_d${desktopSize}`]]: desktopSize }, { [styles.inline]: inline }, { [styles.top]: top })}></div>
}
